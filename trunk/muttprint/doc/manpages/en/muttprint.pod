...
I<Latex>, I<Latex-bright>, I<Times>, I<Utopia>, I<Palatino>, I<Charter>, 
I<Bookman>, I<CentSchool>, I<Chancery>, I<Helvetica> and I<AvantGarde>.
If all fonts are available on your system depends of your installed
LaTeX-system. Default is I<Latex>.
...
Choose a style for the printing of the mailheaders on the first page: I<plain>,
