# Hungarian translations by Fekete Zoltán <fekete@mail.szivarvanynet.hu>
...
("Feladó:", "Címzett:", "Tárgy:", "Másolatot kap:", "Dátum:", "Hírcsoportok:", "Szervezet:");

$String{PageOf} = "Oldal %s / %s";
