...
F<##DOCDIR##/muttprint/muttprint-doc-XX.html> dove XX va
...
semplicemente F<##DOCDIR##/muttprint/sample-muttprintrc-it>
in to F<##SYSCONFDIR##/Muttprintrc> o in F<~/.muttprintrc> se vuoi cambiare le
...
B<NOTE PER L'UTENTE:> L'impostazione C<PRINTER="lp"> non ottiene
...
F<sample-muttprintrc-it> distribuito con B<Muttprint>):
...
F<##TEMPDIR##/muttprint.log>. Utile per avere qualche informazione in più del
