...
and HTML format at F</usr/share/doc/packages/muttprint/>.
...
F</usr/share/doc/packages/muttprint/sample-muttprintrc-en>
...
Specifies another configuration file, which is read additionally to F</etc/Muttprintrc>
