...
Diese Man Page enthält eine kurze Beschreibung von B<Muttprint>. Ursprünglich
...
Hier können Sie eine schöne Schriftfamilie für den Ausdruck auswählen. Möglich
...
I<original> wird das Datum unverändert wie im Mailheader gedruckt, d. h. auf Englisch
...
Über diese Option lässt sich das Datums-format (falls I<local> gewählt
...
in Sternchen (C<*>) für Fettdruck oder in Schrägstriche (C</>) für Kursivschrift
