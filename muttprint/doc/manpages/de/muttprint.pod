...
Dies kann in beispielsweise in Ihrer F<~/.bashrc> vorgenommen werden. Für
genauere Informationen über die Lokalisierung von B<Muttprint> lesen Sie
...
Für CUPS Benutzer eine Anmerkung:  Die Einstellung I<PRINTER="lp"> funktioniert
normalerweise nicht, wenn I<PRINT_COMMAND=CUPS> angegeben ist. Benutzen Sie
stattdessen den Druckernamen (z.B. LaserJet), den Sie leicht überprüfen können,
indem Sie B<lpq> auf der Kommandozeile eingeben. Natürlich kann es sein, dass
Ihr Drucker I<lp> heißt, dann passt die Einstellung I<PRINTER="lp">.
...
I<Helvetica> und I<AvantGarde>. Ob alle Schriften verfügbar sind hängt von
...
I<Ovalbox>, I<doublebox>, I<grey>, I<greybox>. Für eine genauere Beschreibung
...
wieder zur Verfügung. Nachteil: Es können keine Fehlermeldungen mehr
...
Das Program B<Muttprint> selbst.
