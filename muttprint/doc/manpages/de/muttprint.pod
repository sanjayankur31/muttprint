...
Wie auch immer, Sie müssen folgende Zeile in Ihre F</etc/Muttrc> oder
F<~/.muttrc> eintragen:

	set print_command="muttprint"

Wenn Sie die Einstellungen von B<Muttprint> anpassen wollen, kopieren Sie
einfach F</usr/share/doc/packages/muttprint/sample-muttprintrc-de> nach
F</etc/Muttprintrc> oder F<~/.muttprintrc> in Abhängigkeit davon, ob Sie die
...
Gibt eine weitere Konfigurationsdatei an, die zusätzlich zur F</etc/Muttprintrc> und
